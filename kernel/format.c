...
/** {{{ \Vtiful\Kernel\Format::textWrap()
 */
PHP_METHOD(vtiful_format, textWrap)
{
    ZVAL_COPY(return_value, getThis());
...
/** {{{ \Vtiful\Kernel\Format::backgroundColor(int $color)
 */
PHP_METHOD(vtiful_format, backgroundColor)
{
    zend_long color;
...
/** {{{ \Vtiful\Kernel\Format::borderStyle(int $style)
 */
PHP_METHOD(vtiful_format, borderStyle)
{
    zend_long style;
...
zend_function_entry format_methods[] = {
        ...
        PHP_ME(vtiful_format, textWrap,             NULL,                     ZEND_ACC_PUBLIC)
        ...
        PHP_ME(vtiful_format, backgroundColor,      format_color_arginfo,     ZEND_ACC_PUBLIC)
        PHP_ME(vtiful_format, borderStyle,          format_border_arginfo,    ZEND_ACC_PUBLIC)
        PHP_ME(vtiful_format, borderColor,          format_color_arginfo,     ZEND_ACC_PUBLIC)
